...
file_paths = ['intents-responses-01.csv','data.txt','output.txt', 'Philips Hue 464487 Smart Bulb User Manual.pdf','internal-security-act-2.pdf']
...
if prompt:
    ...
    # Only show sources if the answer is not the "don't have information" response
    if "I don't have information about that in my current knowledge base" not in assistant_response:
        ...
        # If no information, use GPT-3.5-turbo
